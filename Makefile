...
ELEVATION_MIX_FILE = ele_taiwan_10_50_100_500_marker-2023r2.o5m
...
LANG := zh
CODE_PAGE := 950
ELEVATION_FILE = ele_taiwan_20_100_500-2023r2.o5m
ELEVATION_MIX_FILE = ele_taiwan_20_100_500_marker-2023r2.o5m
EXTRACT_FILE := taiwan-latest
POLY_FILE := Taiwan.poly
MAPSFORGE_BBOX := 20.62439,118.0000,26.70665,123.0348
...
daily:
	...
	$(MAKE_CMD) SUITE=taiwan_odc_dem gmapsupp_zip  
